...
static void wifi_scan(void)
{
    ...
    scan_info_result.scan_done = WIFI_SCAN_BUSY;
...
static void network_task(void *args)
{
    ...
    while (1) {
        ...
        if (wifi_status != wifi_connected_already()) {
            ...
            scan_info_result.scan_done = WIFI_SCAN_UPDATE;
            if (wifi_connected) {
...
void app_network_start(void)
{
    ...
    ret_val = xTaskCreatePinnedToCore(network_task, "NetWork Task", 4 * 1024, NULL, 1, NULL, 0);
