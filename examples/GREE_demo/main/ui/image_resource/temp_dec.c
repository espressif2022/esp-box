...
#ifndef LV_ATTRIBUTE_IMG_TEMP_DEC
#define LV_ATTRIBUTE_IMG_TEMP_DEC
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_TEMP_DEC uint8_t temp_dec_map[] = {
